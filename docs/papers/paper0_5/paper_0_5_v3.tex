...
\input{results/final_experiment_macros.tex}
...
\includegraphics[width=.48\linewidth]{results/three_parts/figures/g1_target_margin_vs_depth.png}\hfill
\includegraphics[width=.48\linewidth]{results/three_parts/figures/g1_signal_dispersion_phase_plane.png}
...
\begin{figure}[H]\centering
\includegraphics[width=.48\linewidth]{results/three_parts/figures/g1_layer_update_covariance.png}\hfill
\includegraphics[width=.48\linewidth]{figures/dataset_v2_jacobian/c_cumulative_error_vs_horizon.png}
...
\begin{figure}[H]\centering
\includegraphics[width=.48\linewidth]{figures/group25/g25_accuracy_surface.png}\hfill
\includegraphics[width=.48\linewidth]{figures/group25/g25_selective_masking.png}
...
\begin{figure}[H]\centering
\includegraphics[width=.48\linewidth]{figures/rnn_comparison/rnn_transformer_accuracy_vs_length.png}\hfill
\includegraphics[width=.48\linewidth]{figures/rnn_comparison/rnn_transformer_accuracy_vs_span.png}
...
Predictive order binds the measured acquisition frontier&supported&three-seed $p^*_{\max}=2$\\
