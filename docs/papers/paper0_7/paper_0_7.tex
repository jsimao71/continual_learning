...
\end{verbatim}
and writes \texttt{results/eligibility\_decision.json}, including source hashes, threshold, accuracy range, and the blocked decision. No model weights, selectors, or persistent state are changed.
